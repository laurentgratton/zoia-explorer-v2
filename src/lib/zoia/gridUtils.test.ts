...
describe('gridUtils', () => {
  describe('getGridPosition', () => {
    it('should calculate position for a block within the same row', () => {
      ...
      expect(getGridPosition(0, 0, 2)).toEqual({ x: 2, y: 0 });
    });
